...
function capitalise(string) {
    return new Promise((resolve, reject) => {
        /* the 'let' keyword means the scope of the following variable is limited to the current code block rather than being scoped by the function. 
...
This only works if the second function takes a single parameter and its value is the returned object from the previous function. */
